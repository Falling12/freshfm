...
const HeroSection: FC = () => {
  return (
    <section id='hero' className='flex flex-col items-center justify-center h-screen bg-hero text-white'>
        ...
        <svg className='absolute bottom-5 cursor-pointer' width="72" height="72" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg">
